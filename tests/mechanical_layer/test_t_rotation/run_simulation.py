"""Test script for running the mechanical layer engine in a simple rotation scenario."""
...
copyfile("../initial_agent_dynamics_files/AgentDynamics_test_t_rotation.xml", "dynamic/AgentDynamics.xml")
