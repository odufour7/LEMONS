"""Test script for running the mechanical layer engine in a simple translation scenario."""
...
copyfile("../initial_agent_dynamics_files/AgentDynamics_test_t_translation.xml", "dynamic/AgentDynamics.xml")
