"""Test script for running the mechanical layer engine in a rolling without sliding agent wall scenario."""
...
copyfile("../initial_agent_dynamics_files/AgentDynamics_test_tangential_spring_agent_wall.xml", "dynamic/AgentDynamics.xml")
