"""Script for building the video of the crowd dynamics simulation in a rolling without sliding agent wall scenario."""
...
Ndt = 150  # How many dt will be performed in total
...
movie_name = "test_tangential_spring_agent_wall"
plotsPath = Path("./plots")
